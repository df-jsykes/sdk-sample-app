(function () {
    ...
    var BASE_PATH = "https://dsp-x.cloud.dreamfactory.com/rest";
    ...
    window.dreamfactory.build = function (resource) {
        ...
        $.ajax({
            ...
            Object.keys(response.models).forEach(function(model){

                var properties = response.models[model].properties;
                Object.keys(properties).forEach(function(property){
                    if(!properties[property].type){
                        console.log("model = " + model);
                        console.log("property = " + property);
                        console.log("type = " + properties[property].type);
                    }
